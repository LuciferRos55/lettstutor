...
class TutorsSample {
  static List<Tutor> tutors = [
    Tutor(
      ...
      "asset/img/sample/tutor/thuy_tien.jpg",
    ...
    Tutor(
      ...
      <String, String>{
        "Interests":
            "Listening to music , Watching English movies, Gardening, Baking, Cooking, Crafting, Hiking with family.",
        "Teaching experience":
            "I am a license teacher I worked as an ESL Teacher for a year now, I tutor for elementary to Senior High School student, I also teach Business English for some Professional Students.",
      },
      <String>[
        "English for kids",
        "Conversational",
    ...
    Tutor(
      ...
      "Mexico",
      5,
      "Hi! I am teacher Hector and I am major in English so if you want to learn about grammar, and want to be fluent in English, I can help you with that. I will make sure you build your confidence in English communication. Are you preparing for an upcoming exam? I can help you with that too! Let's get a score with flying colors!",
      "asset/img/sample/tutor/sample_7.jpg",
      <String>["English", "Spanish"],
      <String, String>{
        "Interests":
            "Hi! I am teacher Zaira and I am majoring in English so if you want to know more about grammar, and wants to be fluent in English, I can help you with that.",
        "Teaching experience":
